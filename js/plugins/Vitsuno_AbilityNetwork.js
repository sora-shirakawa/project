...
var Vitsuno = Vitsuno || {};
Vitsuno.AbilityNet = {};
Vitsuno.AbilityNet.version = 1.00;
...
// ● プラグインの設定値を取得
Vitsuno.AbilityNet.parameters = PluginManager.parameters('Vitsuno_AbilityNetwork');
Vitsuno.AbilityNet.levelUpPoint = Vitsuno.AbilityNet.parameters['Level UP Point'];
Vitsuno.AbilityNet.pointName = Vitsuno.AbilityNet.parameters['Point Name'];
Vitsuno.AbilityNet.pointNameA = Vitsuno.AbilityNet.parameters['Point Name A'];
Vitsuno.AbilityNet.obtainText = Vitsuno.AbilityNet.parameters['Obtain Text'];
Vitsuno.AbilityNet.commandName = Vitsuno.AbilityNet.parameters['Command Name'];
Vitsuno.AbilityNet.perchPadding = Number(Vitsuno.AbilityNet.parameters['Perch Padding']);
Vitsuno.AbilityNet.stageHeight = Number(Vitsuno.AbilityNet.parameters['Perch Stage Height']);

Vitsuno.AbilityNet.pointUpSe = (function(text) {
    return text ? text.split(",") : [];
})(Vitsuno.AbilityNet.parameters['Point UP SE']);

Vitsuno.AbilityNet.learningSe = (function(text) {
    return text ? text.split(",") : [];
})(Vitsuno.AbilityNet.parameters['Learning SE']);
